...
CREATE UNIQUE INDEX CMS_SCHEMA_UNIQUE_NAME_PROJECT_NAME ON CMS_SCHEMA( (DATA_JSON->>'name', DATA_JSON->>'project_name') );
...
CREATE UNIQUE INDEX CMS_SCHEMA_CONTENT_MAPPING_UNIQUE_SCHEMA_NAME_PROJECT_NAME ON CMS_SCHEMA_CONTENT_MAPPING( (DATA_JSON->>'schema_name', DATA_JSON->>'project_name') );
