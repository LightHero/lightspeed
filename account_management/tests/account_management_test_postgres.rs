...
use lightspeed_account_management::repository::postgres::PgAMRepositoryManager;
...
pub type RepoManager = PgAMRepositoryManager;

pub type MaybeType = (LsAMModule<RepoManager>, ContainerAsync<Postgres>);
